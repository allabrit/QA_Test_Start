...
public class Homework2 {
    ...
    public void fromCssToxPath(){
        ...
        wd.findElement(By.xpath("//div[@host]"));

        wd.findElement(By.cssSelector("table#contry tr:nt-child(3)) td:last-child"));
        wd.findElement(By.xpath("//table[@contry]/tr[3]/td[last()]"));

        wd.findElement(By.cssSelector("div#idName li:first-child"));
        wd.findElement(By.xpath("//div[@id='idName']//li[last()]"));

        wd.findElement(By.cssSelector("div#sort>div:nth-child(2)"));
        wd.findElement(By.xpath("//div[@id='sort'/folowing-sibling::div[2]]"));
    ...
    public void fromXPathToCss(){
        ...
        wd.findElement(By.cssSelector("#id='host'"));
        ...
        wd.findElement(By.cssSelector("div.class='first'.class='list'"));
        ...
        wd.findElement(By.cssSelector("div#id=’idName’h1 :last-child"));
